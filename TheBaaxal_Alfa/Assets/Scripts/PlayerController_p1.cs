...
public class PlayerController_p1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (joyarray.Length >0)
        {
            ...
            gameObject.GetComponentInChildren<Disc_Rotator>().joyConnected = true;
        }
        else
        {
            joystickConnected = false;
            gameObject.GetComponentInChildren<Disc_Rotator>().joyConnected = false;
        ...
        if (Input.GetButton("Block0")) //&& canActivateShield)
